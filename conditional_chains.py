...
prompt1 = PromptTemplate(
    template='Classify the sentiment of the following feedback text into positive or negative. {format_instruction} {feedback}',
...
chain.get_graph().print_ascii() # Removed get_graph
